...
class CharacteristicsControllerTest < ActionController::TestCase
  ...
  test "should create characteristic" do
    assert_difference('Characteristic.count') do
      post :create, characteristic: { default_values: @characteristic.default_values, input_kind: @characteristic.input_kind, name: @characteristic.name }
    end
  ...
  test "should update characteristic" do
    put :update, id: @characteristic, characteristic: { default_values: @characteristic.default_values, input_kind: @characteristic.input_kind, name: @characteristic.name }
    assert_redirected_to characteristic_path(assigns(:characteristic))
  end
