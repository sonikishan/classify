...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { advertisement_status_id: @advertisement.advertisement_status_id, deleted: @advertisement.deleted, paid: @advertisement.paid, price: @advertisement.price, title: @advertisement.title, values_xml: @advertisement.values_xml }
    end
  ...
  test "should update advertisement" do
    put :update, id: @advertisement, advertisement: { advertisement_status_id: @advertisement.advertisement_status_id, deleted: @advertisement.deleted, paid: @advertisement.paid, price: @advertisement.price, title: @advertisement.title, values_xml: @advertisement.values_xml }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
